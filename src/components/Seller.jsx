...
const Seller = () => {
    return (
        <div className='py-12 flex items-center justify-center max-md:pt-14 max-md:pb-[90px] overflow-hidden'>
            <div className="container">
                <div className='flex justify-between items-center max-md:flex-col max-md:gap-11'>
                    ...
                    <div>
                        <img className='max-w-[440px] max-md:max-w-[417px] max-md:-translate-x-12' src={sellerImg} alt="seller img" />
                    </div>
                </div>
            </div>
        </div>
